package com.luizafmartinez.calculadoraimc
...
class ResultadoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (bundle != null) {
            ...
            val resultado =
                if (imc < 18.5) "Abaixo do peso"  //Baixo
                else if (imc in 18.5..24.9) "Normal"  //Normal
                else if (imc in 25.0..29.9) "Sobrepeso"  // Sobrepeso
                else "Obeso"  // Obeso
